                ...
                <div className="flex">
                    ...
                    <div className="w-[400px] flex flex-col gap-2 bg-gray-100 rounded-2xl h-full p-4">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <Skill title="Python" score={30} />
                        </div>
                        <div className="w-full h-[2px] bg-orange-500"></div>

                        <SideTitle title="Other Capability" />
                        <div>
                            <span className="font-semibold">Software Architecture:</span> OOP, SOLID, MVC, Microservices, REST API, ERD
                        </div>
                        <div>
                            <span className="font-semibold">Software:</span> Ms office, Photoshop, Illustrator, Figma
                        </div>
                        <div>
                            <span className="font-semibold">Marketing:</span> SEO Algorithms, Google Ads, Google Search Console, Goolge Analytics, Tag Manager
                        </div>
                        <div className="w-full h-[2px] bg-orange-500"></div>
